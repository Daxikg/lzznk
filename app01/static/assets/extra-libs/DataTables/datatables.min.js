...
(function (h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": 激活以升序对列进行排序",
                sSortDescending: ": 激活以降序对列进行排序"
            },
            oPaginate: {sFirst: "首页", sLast: "最后一页", sNext: "下一页", sPrevious: "上一页"},
            sEmptyTable: "请登录后查看，或表中暂没有可用数据",
            sInfo: "展示 _START_ 至 _END_ 的 _TOTAL_ 个条目",
            sInfoEmpty: "展示 0 至 0 的 0 个条目",
            sInfoFiltered: "(从 _MAX_ 个总条目中过滤)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "展示 _MENU_ 条目",
            sLoadingRecords: "加载中...",
            sProcessing: "处理中...",
            sSearch: "搜索:",
            sSearchPlaceholder: "",
